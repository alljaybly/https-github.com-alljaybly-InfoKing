...
const BrainstormModal: React.FC<BrainstormModalProps> = ({ idea, result, isLoading, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex justify-center items-center z-50 animate-fade-in p-4" onClick={onClose}>
      <div 
        className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-3xl m-auto p-6 md:p-8 animate-slide-in flex flex-col" 
        ...
        {/* Footer */}
        <div className="flex-shrink-0 flex justify-end pt-6 mt-4 border-t border-gray-200 dark:border-gray-700">
